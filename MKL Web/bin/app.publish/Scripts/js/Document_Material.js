...
function cmd_view_data_document(isboq, boqtype) {
    ...
    $.ajax({
        ...
        data: {
            ...
            , isBoq: isboq, BoqType: boqtype, procode: $("#cbo_ocrcode").val(), cardcode: cardcode
        },
        datatype: 'json',
        beforeSend: function () {
            $("#loading").show();
        ...
        success: function (data) {
            ...
            for (i = 0; i < data.data.length; i++) {
                ...
                tr = tr + "<td style='display:none' id='td_pop_line_filer_dis_amount_" + i + "'>" + x.DiscountAmt + "</td>";
                tr = tr + "<td style='display:none' id='td_pop_line_filer_line_total_" + i + "'>" + x.LineTotal + "</td>";

                tr = tr + "<td style='display:none' id='td_pop_line_filer_net_amount_" + i + "'>" + x.NetPrice + "</td>";
                tr = tr + "<td style='display:none' id='td_pop_line_filer_price_after_disc_" + i + "'>" + x.PriceAftDisc + "</td>";
                tr = tr + "</tr>";
...
function cmd_choose_document_v1() {
    ...
    for (i = 0; i < list_distinct_item.length; i++) {
        ...
        $.each(list_selected_item, function (key, value) {
            ...
            if (value.ItemCode == list_distinct_item[i]) {
                ...
                data = data + "<tr name='tr_detail_" + headerrowindex + "' style='display:none' id='tr_pr_detail_" + headerrowindex + "" + detailrowindex + "'>";
                data = data + "<td></td>";
                ...
                data = data + "<td><div class='form-group'><input type='text' style='text-align:right' class='form-control form-control-insde' placeholder='BOQ Quantity' id='txt_line_detail_ori_qty_" + headerrowindex + "" + detailrowindex + "' value='" + convert2digit(value.Quantity) + "'></div></td>";
                ...
                data = data + "<td><div class='form-group'><input type='text' style='text-align:right' class='form-control form-control-insde' name='name_line_detail_qty_" + headerrowindex + "' id='txt_line_detail_qty_" + headerrowindex + "" + detailrowindex + "' placeholder='Price' value='0.0000' onchange='change_line_detail(" + headerrowindex + "" + detailrowindex + "," + headerrowindex + ")'></div></td>";
                data = data + "<td><div class='form-group'><input type='text' style='text-align:right' class='form-control form-control-insde' readonly='readonly' name='name_line_detail_qty_" + headerrowindex + "' id='txt_line_detail_qty_" + headerrowindex + "" + detailrowindex + "' placeholder='Last Purcahse Price' value='" + convert4digit(value.LastPurchasePrice) +"' onchange='change_line_detail(" + headerrowindex + "" + detailrowindex + "," + headerrowindex + ")'></div></td>";

                data = data + "<td><div class='form-group'><input type='text' style='text-align:right' class='form-control form-control-insde' name='name_line_detail_qty_" + headerrowindex + "' id='txt_line_detail_qty_" + headerrowindex + "" + detailrowindex + "' placeholder='Price' value='0.00' onchange='change_line_detail(" + headerrowindex + "" + detailrowindex + "," + headerrowindex + ")'></div></td>";
                data = data + "<td><div class='form-group'><input type='text' style='text-align:right' class='form-control form-control-insde' name='name_line_detail_qty_" + headerrowindex + "' id='txt_line_detail_qty_" + headerrowindex + "" + detailrowindex + "' placeholder='Price' value='0.00' onchange='change_line_detail(" + headerrowindex + "" + detailrowindex + "," + headerrowindex + ")'></div></td>";
                data = data + "<td><div class='form-group'><input type='text' style='text-align:right' class='form-control form-control-insde' placeholder='BOQ Quantity' readonly='readonly' id='txt_line_detail_bal_qty_" + headerrowindex + "" + detailrowindex + "' value='" + convert2digit('0.00') + "'></div></td>";
...
function cmd_choose_document(action) {
    ...
    $("#table_popup_document_list > tbody  > tr").find("input[type='checkbox']").each(function () {
        if (this.checked) {
            ...
            var d = {
                BaseNum: $("#td_pop_line_filer_base_ref_doc_" + id).text(),
                ...
                DiscountAmt: $("#td_pop_line_filer_dis_amount_" + id).text(),
                LineTotal: $("#td_pop_line_filer_line_total_" + id).text(),
                NetPrice: $("#td_pop_line_filer_net_amount_" + id).text(),
                PriceAftDisc: $("#td_pop_line_filer_price_after_disc_" + id).text()
            };
            list_selected_item.push(d);
        }
    });
    ...
    for (i = 0; i < list_distinct_item.length; i++) {
        ...
        if (checkReady == 1) {
            brandname = $("#txt_line_summary_brand_" + headerrowindex).val();
            ...
            $.each(list_selected_item, function (key, value) {
                ...
                if (value.ItemCode == list_distinct_item[i]) {
                    ...
                    data = data + "<td><div class='form-group'><input type='text' style='text-align:right' class='form-control form-control-insde' name='name_detail_dis_per_" + headerrowindex + "' id='txt_line_detail_disc_per_" + headerrowindex + "" + detailrowindex + "' placeholder='Discount %' value='" + convert2digit(value.DiscountPer) + "' readonly='readonly' onchange='change_line_detail(" + headerrowindex + "" + detailrowindex + "," + headerrowindex + ",3)'></div></td>";
                    data = data + "<td><div class='form-group'><input type='text' style='text-align:right' class='form-control form-control-insde' name='name_detail_dis_amt_" + headerrowindex + "' id='txt_line_detail_disc_amt_" + headerrowindex + "" + detailrowindex + "' placeholder='Discount Amount' value='" + convert2digit(value.DiscountAmt) + "' readonly='readonly' onchange='change_line_detail(" + headerrowindex + "" + detailrowindex + "," + headerrowindex + ",4)'></div></td>";
                    ...
                    data = data + "<td style='display:none' id='txt_line_detail_ref_doc_num_" + headerrowindex + "" + detailrowindex + "'>" + value.BaseNum + "</td>";
                    data = data + "<td style='display:none' id='line_detail_item_base_doc_num_" + headerrowindex + "" + detailrowindex + "'>" + value.BaseDocNum + "</td>";
                    data = data + "<td style='display:none' name='name_detail_item_brand_" + headerrowindex + "' id='line_detail_item_brand_" + headerrowindex + "" + detailrowindex + "'>" + brandname+"</td>";
            ...
            data = data + "<td><div class='form-group'><input type='text' class='form-control form-control-insde header-color' id='txt_line_summary_brand_" + headerrowindex + "' placeholder='Brand' value='' onchange='change_line_summary_brand(" + headerrowindex + ")'></div></td>";
            data = data + "<td colspan='2'><div class='form-group'><input type='text' class='form-control form-control-insde header-color' id='txt_line_summary_item_name_" + headerrowindex + "' placeholder='Description' readonly='readonly' value=''></div></td>";
            data = data + "<td><div class='form-group'><input type='text' style='text-align:right' class='form-control form-control-insde header-color' id='txt_line_summary_qty_" + headerrowindex + "' placeholder='Quantity' value='0.00' onchange='change_line_summary(" + headerrowindex + ",1)' ></div></td>";
            data = data + "<td style='display:none'><div class='form-group'><select class='form-control form-control-insde header-color' id='cbo_line_summary_uom_" + headerrowindex + "' onchange='change_line_summary(" + headerrowindex + ",8)'>" + option + "</select></td>";
            ...
            $.each(list_selected_item, function (key, value) {
                ...
                if (value.ItemCode == list_distinct_item[i]) {
                    ...
                    data = data + "<td><div class='form-group'><input type='text' style='text-align:right' class='form-control form-control-insde' placeholder='BOQ Quantity' name='name_detail_qty_" + headerrowindex + "' id='txt_line_detail_qty_" + headerrowindex + "" + detailrowindex + "' value='" + convert2digit(value.Quantity) + "' onchange='change_line_detail(" + headerrowindex + "" + detailrowindex + "," + headerrowindex + ",1)'></div></td>";
                    data = data + "<td style='display:none'><div class='form-group'><select class='form-control form-control-insde' disabled name='name_line_detail_uom_" + headerrowindex + "' id='cbo_line_detail_uom_" + headerrowindex + "" + detailrowindex + "'>" + option + "</select></td>";
                    data = data + "<td><div class='form-group'><input type='text' style='text-align:right' class='form-control form-control-insde' name='name_detail_price_" + headerrowindex + "' id='txt_line_detail_price_" + headerrowindex + "" + detailrowindex + "' placeholder='Price' value='"+ convert2digit(value.UPrice) +"' onchange='change_line_detail(" + headerrowindex + "" + detailrowindex + "," + headerrowindex + ",2)'></div></td>";
                    data = data + "<td><div class='form-group'><input type='text' style='text-align:right' class='form-control form-control-insde' readonly='readonly' placeholder='Last Purcahse Price' value='" + convert4digit(value.LastPurchasePrice) + "' onchange='change_line_detail(" + headerrowindex + "" + detailrowindex + "," + headerrowindex + ")'></div></td>";
            ...
            $("#txt_line_summary_qty_" + headerrowindex).val(convert2digit(total_sub_qty));
            $("#cbo_line_summary_uom_" + headerrowindex).append(uomname);
            change_line_summary(headerrowindex, 2);
            headerrowindex++;
        }
        ...
        $('#table_summary_detail > tbody  > tr').each(function (index, tr) {
            if ($(this).find("td:eq(1)").text() == "H" || $(this).find("td:eq(1)").text() == "S") {
                ...
                var summary = {
                    ...
                    ItemCode: $("#td_line_summary_item_code_" + summaryid).text(),
    ...
    if (allow == 0) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status == "OK") {
                    location.reload();
                    ShowAlert("Purchase Order was saved");
                }
                else {
                    if (data.status == "300") {
                        ShowAlert("PR Quantity is greater than BOQ Quantity");
                    ...
                    if (data.status == "500") {
                        ShowAlert("This Purchase Order No already integrated to SAP");
                    } else {
                        alert(data.Message);
                    }
                }
