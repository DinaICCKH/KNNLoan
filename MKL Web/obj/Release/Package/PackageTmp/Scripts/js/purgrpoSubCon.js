    ...
    $("#table_popup_document_list > tbody  > tr").find("input[type='checkbox']").each(function () {
        if (this.checked) {
            ...
            var d = {
                ...
                Price: $("#td_pop_line_filer_price_" + id).text(),
                DisPer: $("#td_pop_line_filer_dis_per_" + id).text(),
                DisAmt: $("#td_pop_line_filer_dis_amt_" + id).text(),
        ...
        if (checkReady == 1) {
            ...
            $.each(list_selected_item, function (key, value) {
                ...
                if (value.ItemCode == list_distinct_item[i]) {
                    ...
                    data = data + "<td style='display:none'><input type='text' id='txt_line_detail_price_" + headerrowindex + "" + detailrowindex + "' value='" + value.Price + "'></td>";
                    data = data + "<td style='display:none'><input type='text' id='txt_line_detail_disc_per_" + headerrowindex + "" + detailrowindex + "' value='" + value.DisPer + "'></td>";
                    data = data + "<td style='display:none'><input type='text' id='txt_line_detail_disc_amt_" + headerrowindex + "" + detailrowindex + "' value='" + value.DisAmt + "'></td>";
                    data = data + "<td style='display:none'><input type='text' id='txt_line_detail_total_" + headerrowindex + "" + detailrowindex + "' value='0.00'></td>";
                    data = data + "<td style='display:none' id='txt_line_detail_net_price_" + headerrowindex + "" + detailrowindex + "'>" + value.NetPrice + "</td>";
                    data = data + "<td style='display:none' id='txt_line_detail_price_after_dis_" + headerrowindex + "" + detailrowindex + "'>" + value.PriceAftDisc + "</td>";
                    ...
                    data = data + "<td style='display:none' id='td_po_line_grpo_detail_complete_term1_" + headerrowindex + "" + detailrowindex + "'>" + value.CompleteTerm1 + "</td>";
                    data = data + "<td style='display:none' id='td_po_line_grpo_detail_complete_term2_" + headerrowindex + "" + detailrowindex + "'>" + value.CompleteTerm2 + "</td>";
                    data = data + "<td style='display:none' id='td_po_line_grpo_detail_complete_term3_" + headerrowindex + "" + detailrowindex + "'>" + value.CompleteTerm3 + "</td>";
                    data = data + "<td style='display:none' id='td_po_line_grpo_detail_complete_term4_" + headerrowindex + "" + detailrowindex + "'>" + value.CompleteTerm4 + "</td>";
                    data = data + "<td style='display:none' id='td_po_line_grpo_detail_complete_term5_" + headerrowindex + "" + detailrowindex + "'>" + value.CompleteTerm5 + "</td>";
                    data = data + "<td style='display:none' id='td_po_line_grpo_detail_complete_term6_" + headerrowindex + "" + detailrowindex + "'>" + value.CompleteTerm6 + "</td>";
                    data = data + "<td style='display:none' id='td_po_line_grpo_detail_complete_term7_" + headerrowindex + "" + detailrowindex + "'>" + value.CompleteTerm7 + "</td>";
                    data = data + "<td style='display:none' id='td_po_line_grpo_detail_complete_term8_" + headerrowindex + "" + detailrowindex + "'>" + value.CompleteTerm8 + "</td>";
                    data = data + "<td style='display:none' id='td_po_line_grpo_detail_complete_term9_" + headerrowindex + "" + detailrowindex + "'>" + value.CompleteTerm9 + "</td>";
                    data = data + "<td style='display:none' id='td_po_line_grpo_detail_complete_term10_" + headerrowindex + "" + detailrowindex + "'>" + value.CompleteTerm10 + "</td>";
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (i = 0; i < data.data.length; i++) {
                ...
                tr = tr + "<td style='display:none' id='td_pop_line_filer_brand_code_" + i + "'>" + x.Brand + "</td>";
                tr = tr + "<td style='display:none' id='td_pop_line_filer_brand_name_" + i + "'>" + x.Brand + "</td>";
                ...
                tr = tr + "<td style='display:none' id='td_pop_line_filer_price_" + i + "'>" + returnstringvalue(x.UPrice) + "</td>";
                tr = tr + "<td style='display:none' id='td_pop_line_filer_dis_per_" + i + "'>" + returnstringvalue(x.DiscountPer) + "</td>";
                tr = tr + "<td style='display:none' id='td_pop_line_filer_dis_amt_" + i + "'>" + returnstringvalue(x.DiscountAmt) + "</td>";
                tr = tr + "<td style='display:none' id='td_pop_line_filer_net_price_" + i + "'>" + returnstringvalue(x.NetPrice) + "</td>";
                tr = tr + "<td style='display:none' id='td_pop_line_filer_price_after_dis_" + i + "'>" + returnstringvalue(x.PriceAftDisc) + "</td>";
    ...
    if (allow == 0) {
        ...
        $('#table_summary_detail > tbody  > tr').each(function (index, tr) {
            if ($(this).find("td:eq(1)").text() == "H" || $(this).find("td:eq(1)").text() == "S") {
                ...
                var detailid = $(this).attr('id').replace("tr_detail_", "");
                var detail = {
                    LineNum: $("#td_po_line_grpo_detail_line_num_" + detailid).text(),
                    GRPOHLine: summaryid,
                    ...
                    UPrice: $("#txt_line_detail_price_" + detailid).val(),
                    DisPer: $("#txt_line_detail_disc_per_" + detailid).val(),
                    DisAmount: $("#txt_line_detail_disc_amt_" + detailid).val(),
                    LineTotal: $("#txt_line_detail_total_" + detailid).val(),
                    NetPrice: $("#txt_line_detail_net_price_" + detailid).text(),
                    PriceAftDisc: $("#txt_line_detail_price_after_dis_" + detailid).text(),
                    ...
                    CompleteTerm1: returnstringvalue($("#td_po_line_grpo_detail_complete_term1_" + detailid).text()),
                    CompleteTerm2: returnstringvalue($("#td_po_line_grpo_detail_complete_term2_" + detailid).text()),
                    CompleteTerm3: returnstringvalue($("#td_po_line_grpo_detail_complete_term3_" + detailid).text()),
                    CompleteTerm4: returnstringvalue($("#td_po_line_grpo_detail_complete_term4_" + detailid).text()),
                    CompleteTerm5: returnstringvalue($("#td_po_line_grpo_detail_complete_term5_" + detailid).text()),
                    CompleteTerm6: returnstringvalue($("#td_po_line_grpo_detail_complete_term6_" + detailid).text()),
                    Brand: $("#td_po_line_grpo_detail_brand_" + detailid).text()
                };
